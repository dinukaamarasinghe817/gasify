...
class Navigation {
    ...
    public function customer($active){
        ...
        <ul class="nav-tiles">
            <li class="nav-tile">';
            if($active=="dashboard"){
                echo '<a href="dashboard.php" class="panel-tile active dashboard">';
            }else{
                echo '<a href="dashboard.php" class="panel-tile dashboard">';
            }
            ...
            if($active=="myreservation"){
                echo ' <a href="allmyreservation.php" class="panel-tile active my_reservation">';
            }else{
                echo '<a href="allmyreservation.php" class="panel-tile my_reservation"> ';
            }
