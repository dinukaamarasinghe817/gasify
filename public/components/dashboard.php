...
class NewOrder{
    ...
    public function dispatched($data){
        $row = $data['row'];
        $products = $data['products'];
        echo '<div class="box">
                    <div class="label">Order ID : '.$row['order_id'].'
                    ...
                    <div class="content">
                        <span><strong>Customer ID :</strong> '.$row['customer_id'].'</span> &nbsp;
                        <span><strong>Customer Name :</strong> '.$row['customer_name'].'</span><br>
                        <span><strong>Delivery Person ID :</strong>'.$row['delivery_id'].'</span> &nbsp;
                        <span><strong>Delivery Person Name :</strong>'.$row['delivery_name'].'</span>
                        <hr>
                        <table class="styled-table">
                            <thead>
                                <tr>
