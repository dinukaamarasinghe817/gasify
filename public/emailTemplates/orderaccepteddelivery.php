...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-family: 'Montserrat',sans-serif; font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">Your order with <strong>Order ID : {ORDER_ID}</strong> has been <strong>accepted</strong> and will be picked by a delivery person soon, we will let you know once your package is on its way. Check the details of your order using the link below.</p>
  </div>
