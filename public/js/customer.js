function customerprompt(variant=null,forwardlink=null,backwardlink=null){
    ...
    if(variant == 'confirmdelivery'){
        ...
        <div class="buttons">
            <button onclick="location.href='${forwardlink}'">
            <svg width="35" height="35" viewBox="0 0 37 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Pick up</button>
            <button onclick="location.href='${backwardlink}'">
