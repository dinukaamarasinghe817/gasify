function customerprompt(variant=null,forwardlink=null,backwardlink=null){
    ...
    //dashbord toast 
        ...
        <div class="buttons">
            <button  class= "btn-red" onclick="customerprompt();customerprompt('deliverymethod');">Cancel</button>
            <button  class= "btn-blue" onclick="customerprompt();customerprompt('changedeliveryaddress');">Edit</button>
            <button class="btn-blue" onclick="location.href='${forwardlink}'">OK</button>
        </div> `;
        ...
        <div class="buttons">
            <button  class= "btn-red" onclick="displaychargeandaddress()">Cancel</button>
