    ...
    <div class="under_topbar">
        ...
        <div class="delivery_middle">
            <div class="delivery_middle_content">
                ...
                <div class="deliver_address"><h3><?php echo $data['street'] ,' , ', $data['city']; ?></h3> <button onclick="customerprompt('deliveryaddress','<?php echo BASEURL;?>/Orders/select_delivery_method/<?php echo $order_id?>','<?php echo $data['selected_city']; ?>'); return false;" class="edit_btn">edit</button></div>
                ...
                <div class="content_bottom">
                    ...
                    <div class="button_bottom">
                        ...
                        <button  id="confirm_btn" onclick="customerprompt('thankyou','<?php echo BASEURL;?>/Orders/getcollecting_method/Delivery/<?php echo $order_id?>'); return false;" class="btn">Confirm</button>
