    ...
    <script>
        ...
        <div class="middle">
            <!-- <div class="middle_content"> -->
                    ...
                    <!-- <div class="c_methods">
                        <div class="c_btn">
                        <button onclick="customerprompt('thankyou','<?php echo BASEURL;?>/Orders/getcollecting_method/Pickup/<?php echo $order_id?>'); return false;" >
                        ...
                        <?php
                    //         $url = BASEURL.'/Orders/select_delivery_method/'.$order_id.'';
        ...
        <!-- <div class="bottom">
            <a href="<?php echo BASEURL; ?>/Orders/select_payment_method" class="btn" id="back_btn">Back</a>
