    ...
    <div class="under_topbar">
        ...
        <div class="bottom">
            ...
            <div class="bottom_content">
                ...
                <div class="p_methods">
                    <div class="btn"><button onclick="location.href = '<?php echo BASEURL; ?>/Orders/payment_gateway'">
                    ...
                    <div class="btn"><button onclick="location.href = '<?php echo BASEURL; ?>/Orders/bank_slip_upload'">
