...
<section class="body">
    ...
    <div class="body-content">
        <div class="top-panel">
            <ul>
                <li><a href="" class="current active">Regular</a></li>
                <li><a href="" class="current">Refund</a></li>
            </ul>
        </div>
                        ...
                        <li>
                            <div class="person payment">
                                <div class="payment-header">
                                    <div>
                                        <p>Order ID : 1</p>
                                        <p>Customer Name : Sasangi Nayanathara</p>
                                    </div>
                                    <div>
                                        <p>Date : 2023/1/2</p>
                                        <p>Time : 09:15 am</p>
                                ...
                                <div class="payment-body">
                                    <div>
                                        ...
                                        <div>
                                            <p>Dealer's Bank : Commercial Bank</p>
                                            <p>Dealer's Acc Number : 1010457986</p>
                                        </div>
                                    </div>
