            ...
            <div class="middle">
                ...
                <div class="accordion new">
                    ...
                    <?php 
                        ...
                        foreach($pendings as $pending) {
                            ...
                            $output .= '
                                <div class="content">
                                    <div class="details">
                                        <span><strong>Dealer ID : </strong></span>
                    ...
                    ?>
                        ...
                        <!-- <div class="labelbgn">
                            <div class="label"> Pending Distribution ID : 3 </div>
                            <div class="label"><button class="inside">Assign Vehicle</button></div>
                            <div class="label"><button class="inside">Distributed</button></div>
                    ...
                    <!-- <div class="box">
                        <div class="labelbgn">
                            <div class="label"> Pending Distribution ID : 10 </div>
                            <div class="label"><button class="inside">Assign Vehicle</button></div>
                            <div class="label"><button class="inside">Distributed</button></div>
