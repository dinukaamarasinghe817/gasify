        ...
        <div class="split right">
            ...
            <!-- </div> -->
                ...
                <div class="accordion new">
                    ...
                    <div class="box">
                        <?php
                            $acceptedorders = $data['acceptedinfo'];
                        ...
                        <!-- <div class="labelbgn">
                            <div class="label"> Accepted Order ID : 3 </div>
                        ...
                        <!-- <div class="content">
                            <span><strong>Accepted Order Details : </strong></span>
                            <hr>
                            <table>
                                <thead>
                                    <tr>
                    ...
                    <!-- <div class="box">
                        <div class="labelbgn">
                            <div class="label"> Accepted Order ID : 4 </div>
                            <div class="label"> Total Amount : Rs.300 000.00 </div>
                            <div class="label">
                                <button class="inside">Assign Vehicle</button>
                            </div>
                            <svg class="img" width="30" height="16" viewBox="0 0 35 16" fill="none" xmlns="http://www.w3.org/2000/svg">
