        ...
        <div class="split right">
            ...
            <div class="middle">
                ...
                <div class="accordion new">
                        <?php
                            // delayed gas orders details
                            $acceptedorders = $data['acceptedorders'];
                            if(count($acceptedorders)>0) { //if delayed gas orders are available
                                foreach($acceptedorders as $acceptedorder) {
                                    ...
                                    $output .='
                                        <div class="label">Delayed Purchase Order ID : '.$order_id.'  </div>                                
                            ...
                            }else { //if delayed gas orders are not available
                                $output = '';
                                $output = '</table>';
