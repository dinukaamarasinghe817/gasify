...
<section class="body">
    ...
    <section class="body-content">
        ...
        if(mysqli_num_rows($query)>0) {
            ...
            $query2=mysqli_query($conn, "SELECT * FROM distributor_vehicle WHERE distributor_id = '{$user_id}' ");
            ...
            if(mysqli_num_rows($query2)>0) {
                while($row2 = mysqli_fetch_assoc($query2)) {
                    ...
                    // $query3 = mysqli_query($conn, "SELECT DISTINCT d.capacity AS capacity, p.name AS product_name FROM distributor_vehicle_capacity d INNER JOIN product p ON d.product_id = p.product_id WHERE d.distributor_id = '{$user_id}' AND d.vehicle_no = '{$vehicle_no}'");
