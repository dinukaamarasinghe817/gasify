             ...
             echo "Your Vehicles' Details : ".'<br><br>'; 
                ...
                foreach($vehicles as $vehicle){
                    ...
                    $output .= '</table>
                                ...
                                $output .= '<td><button type="button" class="btn4" style="background-color: #875899" onclick="document.location.href=\''.BASEURL .'/vehicles/updateVehiclePage\'">Update</button></td>';
