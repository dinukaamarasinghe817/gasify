        ...
        <div class="split right">
            ...
            <div class="middle">
                ...
                <div class="accordion new">
                    ...
                    <div class="box">
                        <?php
                            $completedorders = $data['acceptedorders'];
                            foreach($completedorders as $completedorder) {
                                $row1 = $completedorder['acceptedinfo'];
                                ...
                                $output .='
                                    <div class="label">Completed Purchase Order ID : .'{$order_id}'. </div>
                        ...
                        <!-- <div class="labelbgn">
                            <div class="label"> Completed Order ID : 1 </div>
                        ...
                        <!-- <div class="content">
                        <span><strong>Assigned Vehicle Number : HR5667</strong></span> &nbsp; <br> 
                        <span><strong>Completed Order Details : </strong></span>
                            <hr>
                            <table>
                                <thead>
                                    <tr>
                    ...
                    <!-- <div class="box">
                        <div class="labelbgn">
                            <div class="label">Completed Order ID : 2 </div>
                        ...
                        <div class="content">
                            <span><strong>Assigned Vehicle Number : AW1221</strong></span>&nbsp;<br>
                            <span><strong>Completed Order Details : </strong></span>
                            <hr>
                            <table>
                                <thead>
