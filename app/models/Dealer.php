...
class Dealer extends Model
{
    ...
    public function customerOrder($customer_id,$dealer_id,$products,$payment_method){
        ...
        if($payment_method == 'Credit card'){
            ...
            $order_id = $this->addtoReservation($customer_id,$dealer_id,$products,$payment_method,'Pending');
            ...
            $image = getImageRename($payslip['image_name'],$payslip['temp_name']);
    ...
    public function dealerOrders($dealer_id,$tab1,$tab2){
        ...
        r.min_distance AS min_distance,
        r.max_distance AS max_distance,
